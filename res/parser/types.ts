...
export interface BotEvent extends EventEmitter {
  ...
  once(event: 'group_message', listener: (msg: GroupMessage) => void): any
  once(event: 'private_message', listener: (msg: PrivateMessage) => void): any
  once(event: 'group_file_upload', listener: (msg: GroupFileUpload) => void): any
  once(event: 'group_admin_change', listener: (msg: GroupAdminChange) => void): any
  once(event: 'group_decrease', listener: (msg: GroupMemberChange) => void): any
  once(event: 'group_increase', listener: (msg: GroupMemberChange) => void): any
  once(event: 'group_mute', listener: (msg: GroupMute) => void): any
  once(event: 'friend_add', listener: (msg: FriendAdd) => void): any
  once(event: 'group_recall', listener: (msg: GroupRecall) => void): any
  once(event: 'friend_recall', listener: (msg: FriendRecall) => void): any
  once(event: 'poke', listener: (msg: GroupPoke) => void): any
  once(event: 'lucky_king', listener: (msg: LuckyKing) => void): any
  once(event: 'honor', listener: (msg: GroupHonor) => void): any
  once(event: 'friend_request', listener: (msg: FriendRequest) => void): any
  once(event: 'group_request', listener: (msg: GroupRequest) => void): any
}